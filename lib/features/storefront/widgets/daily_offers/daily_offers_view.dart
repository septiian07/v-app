...
import 'package:tactical_app/features/storefront/widgets/daily_offers/daily_offers_content.dart';
...
class DailyOffersView extends StatelessWidget {
   const DailyOffersView({super.key});
   ...
   Widget build(BuildContext context) {
     ...
     return Scaffold(
       ...
       appBar: AppBackAppBar(
         title: l10n.storeDailyOffersTitle.toUpperCase(),
       ),
       body: SafeArea(
